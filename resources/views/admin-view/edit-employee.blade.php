        ...
        <div class="row">
          ...
          <div class="col-md-12">
			...
			@elseif(session('failed'))
              ...
              <form id="tasks_form" method="post" action="{{ url('employee-update/'.$employee_detail->id) }}">	
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label for="dob">  Date of Birth:   </label>
                                <input type="text" name="dob" class="form-control date" id="dob" placeholder="Enter date of birth" value="{{$employee_detail->date_of_birth}}">
                            @error('dob')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
					...
					<div class="row">
						<div class="col-sm-4">
                            ...
                            @foreach ($get_designations_data as $designation)
                                <option value="{{ $designation->id }}" {{ ( $designation->id == $employee_detail->designation) ? 'selected' : '' }}>{{ $designation->title }}</option>
                            @endforeach
						    </select>
                        ...
                        <div class="col-sm-4">
                            ...
                            @foreach ($get_departments_data as $department)
                                <option value="{{ $department->id }}" {{ ($department->id == $employee_detail->department) ? 'selected' : '' }}>{{ $department->title }}</option>
                            @endforeach
						    </select>
                        ...
                        <div class="col-sm-4">
                            <label for="doj">  Date of joining:   </label>
                                <input type="text" name="doj" class="form-control date" id="doj" placeholder="Enter date of joining" value="{{$employee_detail->date_of_joining}}">
                            @error('doj')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
